...
$APPLICATION->SetPageProperty("description", "Каталог товаров для домашних животных интернет-магазина Pethappy.ru");
$APPLICATION->SetPageProperty("TITLE", "Каталог товаров для домашних животных");
