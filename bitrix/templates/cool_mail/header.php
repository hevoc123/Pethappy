...
<body class="" data-bx-block-editor-block-status="content"
      style="-ms-text-size-adjust: 100%;-webkit-text-size-adjust: 100%;height: 100% !important;margin: 0;padding: 0;font-family: Arial, Helvetica, sans-serif;width: 100% !important;background: url(http://pethappy.ru/images/pets_1.jpg) !important;">
<div style="width: 100%; padding-top: 15px; background: url(http://pethappy.ru/images/pets_1.jpg);">
        ...
        <center>
            <ul class="menu cleara" style="display: block;height: 35px; background: #436DAD; color: #FFF; padding: 0;margin: 0;list-style: outside none none;">
                <li style="float: left;margin-left: 20px;-ms-text-size-adjust: 100%;-webkit-text-size-adjust: 100%;mso-line-height-rule: exactly;">
                    <a href="http://pethappy.ru/personal/" style="color: #FFF;font: 13px/34px Arial, sans-serif;display: block;word-wrap: break-word;-ms-text-size-adjust: 100%;-webkit-text-size-adjust: 100%;mso-line-height-rule: exactly;">Личный
                        кабинет</a>
                </li>
                <li style="float: left;margin-left: 20px;-ms-text-size-adjust: 100%;-webkit-text-size-adjust: 100%;mso-line-height-rule: exactly;">
                    <a href="http://pethappy.ru/personal/cart/" style="color: #FFF;font: 13px/34px Arial, sans-serif;display: block;word-wrap: break-word;-ms-text-size-adjust: 100%;-webkit-text-size-adjust: 100%;mso-line-height-rule: exactly;">Корзина</a>
                </li>
                <li style="float: left;margin-left: 20px;-ms-text-size-adjust: 100%;-webkit-text-size-adjust: 100%;mso-line-height-rule: exactly;">
            ...
            <div style="background: #F5F6F6; height: 77px;">
                <div style="float: left; padding: 15px 30px; width: 170px;">
                    <a href="http://pethappy.ru" title="Интернет-зоомагазин Pethappy.ru">
                        <img style="width: 165px; height: 43px;" src="http://pethappy.ru/bitrix/templates/empty/img/logo.png" alt="Интернет-зоомагазин Pethappy.ru">
                    </a>
                </div>
                <div style="float: right; padding: 15px 30px; width: 250px; font-weight: bold;">
                    <div style="float: left; width: 45px; height: 46px;">
                        <a href="http://pethappy.ru" title="Интернет-зоомагазин Pethappy.ru"><img src="http://pethappy.ru/images/print-phone_time.png" alt="Интернет-зоомагазин Pethappy.ru"></a>
                    </div>
