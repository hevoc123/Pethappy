...
if (strlen($arResult["ERROR_MESSAGE"]) <= 0)
{
	...
	?>
		<form method="post" action="<?=POST_FORM_ACTION_URI?>" name="basket_form" id="basket_form">
			<div id="shopcart">
				<div id="shopcart-header-b-prod_exist" style="">
					<div class="sec-cart clearfix">
			...
			<tr>
				<td style="text-align: center">
					<div class="empty_cart">
						<h1 class="h1-title">Ваша корзина пустая!</h1>
						<p class="p-text">Прежде чем оформить заказ, добавьте товары в корзину</p>
					</div>
				</td>
			</tr>
			<tr>
				<td style="text-align: center">
					<img style="max-width: 425px; width: 100%;" src="/images/empty-basket.jpg" />
				</td>
			</tr>
		</tbody>
	</table>
